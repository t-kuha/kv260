...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out0  [get_bd_pins clk_wiz_0/clk_out0] \
  ...
  connect_bd_net -net zynq_ultra_ps_e_1_emio_ttc0_wave_o  [get_bd_pins zynq_ultra_ps_e_0/emio_ttc0_wave_o] \
  [get_bd_pins xlslice_0/Din]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
